    ...
    public class CRMInitializer : System.Data.Entity. DropCreateDatabaseIfModelChanges<CRMContext>
    {
        protected override void Seed(CRMContext context)
        {
            ...
            var addresses = new List<Address>
            {
                ...
                new Address{CustomerID=3,NameOrNum="The White House",AddressLine1="Pool Road",AddressLine2="Miami",Postcode="D23 8TY",County="Florida",Country="USA"},
                new Address{CustomerID=3,NameOrNum="15",AddressLine1="Red Path",AddressLine2="Houston",Postcode="Y12 5BR",County="Texas",Country="USA"}
            };
